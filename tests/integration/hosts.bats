...
@test "List hosts in table format" {
    termius host -L test --port 2022 --address 123.2.3.2 --username root
    run termius hosts
    [ "$status" -eq 0 ]
...
@test "List hosts filter by tag" {
    termius host -L test --port 2022 --address localhost --username root
    host_id=$(termius host -L test --port 2022 --address localhost --username root -t A)
...
@test "List hosts in a group" {
    ...
    termius host -L test --address localhost --username root
    host_id=$(termius host -L test --group $group --address localhost --username root)
...
@test "List hosts in child groups, too" {
    ...
    termius host -L test --address localhost --username root
    host_id=$(termius host -L test --group $child_group --address localhost --username root)
...
@test "List hosts only in child groups" {
    ...
    child_group=$(termius group --parent-group $group --port 2022 -L subgroup)
    termius host -L test --address localhost --username root
    termius host -L test --group $group --address localhost --username root
    host_id=$(termius host -L test --group $child_group --address localhost --username root)
...
@test "List hosts in a group filter by the tag" {
    group=$(termius group --port 2022 -L group)
    host_id=$(termius host -L test --group $group --address localhost --username root -t A)
    termius host -L test --address localhost --username root -t A
